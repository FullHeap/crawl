...
import com.coin.crawl.util.HttpsUtil;
...
public class RequestAndResponseTool {
	...
	public static Page sendRequstAndGetHttpsResponse(String checkurl) {
		Page page = null;
		byte[] bytes = HttpsUtil.HttpRequestReturnByte(checkurl);
//			System.out.println(new String (bytes,"GB2312"));
		page = new Page(bytes, checkurl, "text/html");
